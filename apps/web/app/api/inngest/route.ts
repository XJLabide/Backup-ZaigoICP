 ...
 * - executeActionFunction: Handles action/approved event to send LinkedIn connection requests
 * - updateCampaignStatsFunction: Handles action/sent and invitation/accepted events to update campaign stats
 */
